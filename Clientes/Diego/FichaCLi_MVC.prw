...
Local oStr_SU5:= FWFormStruct(1, 'SU5') //| Contatos
...
Local aCpo_SU5	:= { 'U5_FILIAL' , 'U5_CODCONT' ,  'U5_CONTAT' ,  'U5_EMAIL', 'U5_CLIENTE', 'U5_LOJA'}
 
 U_MCampos_MVC( aCpo_SA1 , @oStr_SA1 , 'M' )  //| Mantem na Estrutura apenas os Campos contidos no array...
 U_MCampos_MVC( aCpo_SU5 , @oStr_SU5 , 'M' )  //| Mantem na Estrutura apenas os Campos contidos no array...
...
oModel:addGrid('GRID_SU5','FIELD_SA1',oStr_SU5)
...
oModel:SetRelation('GRID_SU5',{ { 'U5_CLIENTE'	, 'A1_COD' }, { 'U5_LOJA'	, 'A1_LOJA' } }, SU5->(IndexKey(1)) )
...
oModel:getModel('GRID_SU5'):SetDescription('Contatos')
...
Local oStr_SU5 := FWFormStruct(2, 'SU5') //| Contatos
...
Local aCpo_SU5	:= { 'U5_FILIAL' , 'U5_CODCONT' ,  'U5_CONTAT' ,  'U5_EMAIL', 'U5_CLIENTE', 'U5_LOJA'} 
 ...
 U_MCampos_MVC( aCpo_SU5 , @oStr_SU5 , 'V' )  //| Mantem na Estrutura apenas os Campos contidos no array...
 U_MCampos_MVC( aCpo_SA1 , @oStr_SA1 , 'V' )  //| Mantem na Estrutura apenas os Campos contidos no array...
 
 oStr_SA1:SetNoFolder() //| Se quisermos retirar as pastas que estão configuradas em uma estrutura, por exemplo, pelo uso da função FWFormStruct, usamos o m�todo SetNoFolder
...
oView:AddGrid(		'FORM_SU5' 	, oStr_SU5	,'GRID_SU5'		)  		//|  Cria Grade de dados (GRID)  baseado numa Estrutura (SU5)...
...
oView:AddSheet('FOLD_DET'	,'FOLHA_SU5'	,'Contatos'		) //| Cria a Folha (Sheet) que irá receber os Dados Contratos (CNA)
...
oView:CreateHorizontalBox( 'BOX_DET_SU5', 100, /*owner*/, /*lUsePixel*/, 'FOLD_DET', 'FOLHA_SU5') 	//| Cria Caixa ( Completa ) com divisao Horizontal dentro de uma Folha (sheet)..
...
oView:SetOwnerView('FORM_SU5','BOX_DET_SU5') //| Define o Box que irá apresentar a Estrutura de Dados na Tela....
